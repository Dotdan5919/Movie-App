...
inputRef.current.value!=="" && updateProfile(user,update)
...
.catch((err)=>{console.log(err.message)})
  ...
  return (
   ...
   {inputActive?(<h1 className='text-gray-400'>{newPropsVal}</h1>):( <input  value={newPropsVal} ref={inputRef} onChange={(e)=>setNewPropsVal(e.target.value)} type='text' name={props.name}  className='p-3' />      )} 
