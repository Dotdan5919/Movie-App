...
const MovieSlider = (prop) => {
  ...
  return (
    ...
    <IoIosArrowDropright onClick={()=>handleClick("right")}  className='absolute text-white flex bottom-[35%]  right-[19%]    text-5xl z-30 hover:scale-[1.2] transition-all duration-700' />
    
    <div className="absolute bg-gradient-to-l from-transparent  to-black  opacity-[.2] my-10 w-20 h-[75%] z-[1]"></div>
    <div className="absolute bg-gradient-to-r from-transparent right-[19%] to-black  opacity-[.9] my-10 w-20 h-[75%] z-[1]"></div>
