...
url='https://www.omdbapi.com/?s=game&type=series&apikey=60879b0d';
url1='https://www.omdbapi.com/?s=love&type=series&apikey=60879b0d';
url2='https://www.omdbapi.com/?s=black&type=series&apikey=60879b0d';
let Arrayval;
    let Arrayval2;
    let Arrayval3;
...
useEffect(
  ...
  return (
    ...
    <div className="grid xl:grid-cols-6 lg:grid-cols-4 sm:grid-cols-3 md:grid-cols-3   grid-cols-2 sm:w-auto w-screen   self-center gap-12    ">
      
    {Array && Array.map((e)=>{

        if(parseInt(e.Year)>2002)
        {
