  ...
  return (
    ...
    <div className='w-screen h-screen relative'>
     ...
     {PlayVideo?false:<img src={MovieThumbnail} alt='Thumbnail' className=' z-20 absolute w-[100%] h-fit'/>}
       <ReactPlayer className=" absolute z-0 top-[-100px] left-[-200px] " url={MoviePlaying} playing={PlayVideo} loop={true} width="130%" height="130%" autoPlay={true}  />
       </div>
...
<div className="grid relative grid-cols-7 grid-rows-6 grid-rows-9    p-10 leading-tight z-10  h-[100%]">
    <h1 className=' text-white text-[50px] font-bold  col-start-1 row-start-1  h-16  col-span-3 self-center  '> {MovieName}</h1>
