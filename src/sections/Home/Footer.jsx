...
const Footer = () => {
  return (
    <div className='w-full p-7 text-white  cursor-pointer'>
...
<h1 className='row-start-3 col-start-4 text-gray-500 font-bold'>Customer support</h1>
<p className='text-gray-50 text-xs font-thin col-start-4 row-start-4 '>Online support</p>
<p className='text-gray-50 text-xs font-thin col-start-4 row-start-5 '>Common question</p>


<h1 className='row-start-3 text-gray-500 font-bold '>Contact</h1>
<p className='text-gray-50 text-xs font-thin row-start-4'>Hotline:124-245-2495</p>
<p className='text-gray-50 text-xs font-thin row-start-5'>Email:contact@moplay.com</p>

<h1 className='row-start-3 text-gray-500 font-bold '>Recruit</h1>
<p className='text-gray-50 text-xs font-thin row-start-4'>Job list</p>
<p className='text-gray-50 text-xs font-thin row-start-5'>Send your Cv</p>


<p className='text-gray-50 text-xs font-thin col-start-1 row-start-[9]'>2024.Moplay.All rights reserved</p>
