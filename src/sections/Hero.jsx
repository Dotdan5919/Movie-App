...
const Hero = () => {
  return (
    <div className='w-full h-fit flex flex-col sm:p-10 p-2' >
...
<h1 className='text-white font-bold sm:text-[70px] text-[60px] leading-tight '>Unlimited, movies and TV shows</h1>
